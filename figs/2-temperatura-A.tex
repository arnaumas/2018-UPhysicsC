...
\begin{picture}(4420.00,3400.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(3496,2384){\rotatebox{-13}{\makebox(0,0){\strut{}\etiqueta{\footnotesize $\mathsfit{A} = \SI{1}{m^2}$}}}}%
      \colorrgb{0.58,0.00,0.83}%%
      \put(2894,1698){\rotatebox{-25}{\makebox(0,0){\strut{}\etiqueta{\footnotesize $\mathsfit{A} = \SI{10}{m^2}$}}}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{2-temperatura-A}}%
    \gplfronttext
  \end{picture}%
\endgroup
